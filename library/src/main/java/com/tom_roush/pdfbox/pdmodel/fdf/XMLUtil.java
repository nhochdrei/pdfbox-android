 ...
 * 
 * @deprecated Use {@link com.tom_roush.pdfbox.util.XMLUtil} instead
 */
@Deprecated
final class XMLUtil
{
    ...
    {
        return com.tom_roush.pdfbox.util.XMLUtil.parse(is);
    }
    ...
    {
        return com.tom_roush.pdfbox.util.XMLUtil.getNodeValue(node);
    }
}
