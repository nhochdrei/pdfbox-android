...
public class TestPDDocumentCatalog
{
    ...
    public void retrievePageLabels() throws IOException
    {
        ...
        try
        {
            doc = PDDocument.load(TestPDDocumentCatalog.class.getResourceAsStream("/pdfbox/org/apache/pdfbox/pdmodel/test_pagelabels.pdf"));
    ...
    public void retrievePageLabelsOnMalformedPdf() throws IOException
    {
        ...
        try
        {
            doc = PDDocument.load(TestPDDocumentCatalog.class.getResourceAsStream("/pdfbox/org/apache/pdfbox/pdmodel/badpagelabels.pdf"));
            PDDocumentCatalog cat = doc.getDocumentCatalog();
    ...
    public void retrieveNumberOfPages() throws IOException
    {
        ...
        try
        {
            doc = PDDocument.load(TestPDDocumentCatalog.class.getResourceAsStream("/pdfbox/org/apache/pdfbox/pdmodel/test.unc.pdf"));
    ...
    public void handleOutputIntents() throws IOException
    {
        ...
        try
        {
            ...
            // add an OutputIntent
            colorProfile = TestPDDocumentCatalog.class.getResourceAsStream("/pdfbox/org/apache/pdfbox/pdmodel/sRGB Color Space Profile.icm");
