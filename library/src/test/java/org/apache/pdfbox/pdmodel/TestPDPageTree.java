...
public class TestPDPageTree
{
    ...
    {
        doc = PDDocument.load(TestPDPageTree.class.getResourceAsStream("/pdfbox/org/apache/pdfbox/pdmodel/with_outline.pdf"));
    ...
    {
        doc = PDDocument.load(TestPDPageTree.class.getResourceAsStream("/pdfbox/org/apache/pdfbox/pdmodel/page_tree_multiple_levels.pdf"));
        for (int i = 0; i < doc.getNumberOfPages(); i++)
        {
            assertEquals(i, doc.getPages().indexOf(doc.getPage(i)));
        }
