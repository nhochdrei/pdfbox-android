...
{
    private static final String PATH_OF_PDF = "/pdfbox/org/apache/pdfbox/pdmodel/interactive/form/AcroFormsBasicFields.pdf";
    ...
    public void testAcroFormsBasicFields() throws IOException
    {
        ...
        try
        {
            try
            {
                doc = PDDocument.load(new File(getClass().getResource(PATH_OF_PDF).toURI()));
            }
